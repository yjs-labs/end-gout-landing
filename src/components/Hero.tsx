...
import goutAsianMan from "../../public/img/asian man gout flare up.png";

export const Hero = () => {
  return (
    <>
      <Container className="relative flex flex-wrap py-8 lg:py-16">
        {/* Subtle radial gradient tying text + image */}
        <div className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle_at_65%_40%,rgba(99,102,241,0.18),transparent_55%)] dark:bg-[radial-gradient(circle_at_65%_40%,rgba(99,102,241,0.25),transparent_55%)]" />
        <div className="flex items-center w-full lg:w-1/2 mb-12 lg:mb-0">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              What most doctors never tell you about managing gout…
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Discover a simple food-based strategy that’s helped thousands
              manage gout naturally — without giving up your life.
            </p>
          </div>
        </div>
        <div className="flex items-center justify-center w-full lg:w-1/2">
          <div className="relative w-[380px] h-[400px] md:w-[500px] md:h-[520px] lg:w-[560px] lg:h-[560px] flex items-center justify-center">
            {/* Organic glow layers */}
            <div className="absolute inset-0 -m-6 rounded-[3rem] bg-gradient-to-tr from-indigo-500/15 via-fuchsia-500/10 to-sky-400/10 blur-2xl" />
            <div className="absolute -bottom-10 -right-10 w-72 h-72 rounded-full bg-gradient-to-br from-fuchsia-400/20 via-indigo-500/10 to-transparent blur-3xl" />
            {/* Framed image with subtle inner border + glass */}
            <div className="relative group w-full h-full p-[3px] rounded-[2.5rem] bg-gradient-to-br from-indigo-400/40 via-slate-200/20 to-transparent dark:via-slate-700/30 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)]">
              <div className="relative w-full h-full overflow-hidden rounded-[2.3rem] bg-slate-50/60 dark:bg-slate-900/50 backdrop-blur-xl">
                <Image
                  src={goutAsianMan}
                  width={616}
                  height={617}
                  alt="Gout relief illustration"
                  loading="eager"
                  placeholder="blur"
                  className="object-cover w-full h-full scale-[1.02] transition-all duration-[1600ms] ease-out group-hover:scale-100 group-hover:brightness-105"
                  style={{ objectFit: "cover" }}
                />
                {/* Soft edge fade to integrate with background */}
                <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_30%_30%,transparent_55%,rgba(15,23,42,0.35))] dark:bg-[radial-gradient(circle_at_30%_30%,transparent_55%,rgba(0,0,0,0.55))] mix-blend-multiply dark:mix-blend-normal" />
                {/* Subtle top highlight */}
                <div className="absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-white/50 via-white/10 to-transparent dark:from-white/10 dark:via-white/5" />
              </div>
              {/* Accent ring on hover */}
              <div className="absolute inset-0 rounded-[2.5rem] ring-1 ring-inset ring-indigo-500/20 group-hover:ring-indigo-400/40 transition-colors" />
            </div>
          </div>
        </div>
      </Container>
